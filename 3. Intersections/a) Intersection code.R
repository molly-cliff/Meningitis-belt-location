...
#TRY AND SEE WHY BLANKS ARE HERE AND FILL IN
...
# Filter the intersections where the area is at least 60% of either district
filtered_intersections60 <- joined_shapefiles[
  joined_shapefiles$'area_intersection' >= 0.6 * joined_shapefiles$'area_original', ]
filtered_intersections60 <-filtered_intersections60 [!duplicated(filtered_intersections60[ , c("district_countryshape")]),]


filtered_intersections60 <-filtered_intersections60 [!duplicated(filtered_intersections60[ , c("district_country_important")]),]

joined_shapefiles_test <- anti_join(joined_shapefiles, filtered_intersections60, by = c("district_country_important"))
filtered_intersections40 <- joined_shapefiles_test[
 joined_shapefiles_test$'area_intersection' >= 0.4 * joined_shapefiles_test$'area_original', ]
#joined_shapefiles$district_countryimportant<-joined_shapefiles$district_country_important

filtered_intersections40 <-filtered_intersections40 [!duplicated(filtered_intersections40[ , c("district_country_important")]),]

# Count the number of qualifying intersections
num_overlapping_districts <- nrow(filtered_intersections60)
filtered_intersections60$weekly_epidemics <- 1
filtered_intersections40$weekly_epidemics <- 1

#these are the ones we can't yet place



filtered_intersections60_subset <- filtered_intersections60[, -which(names(filtered_intersections60) == "district_country")]
filtered_intersections60$district_country<-filtered_intersections60$district_countryimportant

filtered_intersections40 <- filtered_intersections40[!duplicated(filtered_intersections40[, c("district_country_important")]), ]
filtered_intersections40_subset <- filtered_intersections40[, -which(names(filtered_intersections60) == "district_country")]
...
result_df <- anti_join(weeklyincidence_merge, filtered_intersections50, by = "district_countryshape")
