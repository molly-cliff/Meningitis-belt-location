...
Pop_density2005<- read_sf(dsn = ".", layer = "Pop_density2005")
...
Pop_density2000$Pop_density2000 <- Pop_density2000$Pp_dnst
Pop_density2005$Pop_density2005 <- Pop_density2005$Pp_dnst
Pop_density2010$Pop_density2010 <- Pop_density2010$Pp_dnst
Pop_density2015$Pop_density2015 <- Pop_density2015$Pp_dnst
Pop_density2020$Pop_density2020 <- Pop_density2020$Pp_dnst
...
Pop_density2000 <- create_code(Pop_density2000, "NAME_2_", "GID_2")
Pop_density2005 <- create_code(Pop_density2005, "NAME_2_", "GID_2")

Pop_density2010 <- create_code(Pop_density2010, "NAME_2_", "GID_2")
Pop_density2015 <- create_code(Pop_density2015, "NAME_2_", "GID_2")
Pop_density2020 <- create_code(Pop_density2020, "NAME_2_", "GID_2")
...
total3test <- merge(total3test, Pop_density2000, by = c("code", "code"), all.x = TRUE)
total3test <- total3test[!duplicated(total3test$code), ]

total3test <- merge(total3test, Pop_density2005, by = c("code", "code"), all.x = TRUE)
total3test <- total3test[!duplicated(total3test$code), ]

total3test <- merge(total3test, Pop_density2010, by = c("code", "code"), all.x = TRUE)
total3test <- total3test[!duplicated(total3test$code), ]

total3test <- merge(total3test, Pop_density2015, by = c("code", "code"), all.x = TRUE)
total3test <- total3test[!duplicated(total3test$code), ]

total3test <- merge(total3test, Pop_density2020, by = c("code", "code"), all.x = TRUE)
total3test <- total3test[!duplicated(total3test$code), ]
...
final_columns <- c("COUNTRY_x.x", "NAME_1_x.x", "GID_2.x", "NAME_2_x.x", "rainfallzone", 
                   "Humidityzone", "aerozone", "windspeedzone", "Pop_density2000", 
                   
                   "Pop_density2005","Pop_density2010","Pop_density2015","Pop_density2020",
                   "nw_lnd_", 
                   "geometry.y", "code")
...
final_columns <- c("COUNTRY.x", "code", "NAME_2.x", "rainfallzone", "Humidityzone", 
                   "aerozone", "windspeedzone", "Pop_density2000", 
                   
                   "Pop_density2005","Pop_density2010","Pop_density2015","Pop_density2020", "nw_lnd_", "epidemic", 
...
merged_data$weight2000 <- merged_data$weightswithcosine  * merged_data$Pop_density2000
merged_data$weight2005 <- merged_data$weightswithcosine  * merged_data$Pop_density2005
merged_data$weight2010 <- merged_data$weightswithcosine  * merged_data$Pop_density2010
merged_data$weight2015 <- merged_data$weightswithcosine  * merged_data$Pop_density2015
merged_data$weight2020 <- merged_data$weightswithcosine  * merged_data$Pop_density2020



merged_data$weight2000<-merged_data$weight2000/1000
merged_data$weight2005<-merged_data$weight2005/1000
merged_data$weight2010<-merged_data$weight2010/1000
merged_data$weight2015<-merged_data$weight2015/1000
merged_data$weight2020<-merged_data$weight2020/1000

model2 <- glm(epidemic ~ Aero3 +  rainfall3 +humidity3,
              data = merged_data, 
              family = "binomial",
              weights = merged_data$weight2000,method = "brglmFit")
...
model2 <- glm(epidemic ~ Aero3 +  rainfall3 +humidity3,
              data = merged_data, 
              family = "binomial",
              weights = merged_data$weight2005,method = "brglmFit")
...
model2 <- glm(epidemic ~ Aero3 +  rainfall3 +humidity3,
              data = merged_data, 
              family = "binomial",
              weights = merged_data$weight2010,method = "brglmFit")
...
model2 <- glm(epidemic ~ Aero3 +  rainfall3 +humidity3,
              data = merged_data, 
              family = "binomial",
              weights = merged_data$weight2015,method = "brglmFit")
...
model2 <- glm(epidemic ~ Aero3 +  rainfall3 +humidity3,
              data = merged_data, 
              family = "binomial",
              weights = merged_data$weight2020,method = "brglmFit")
